    ...
    export default {
        ...
        methods: {
            ...
            setupShardingSphereServerList() {
                ...
                if (repoType === 'memory') {
                    delete vc.coordinator.configurations.shardingSphere.mode.repository[repoType].serverList
                } else {
                    if (repoType === 'etcd') {
                        delete vc.coordinator.configurations.shardingSphere.mode.repository.zooKeper;
                    } else {
